  ...
  methods: {
    ...
    getIndex(pos, card, side) {
      ...
      if (pos == 1 && side == "right") {
        ...
        if (this.expos + 1 > this.repeater_array.length - 1) {
          return 0;
        } else {
          return this.expos + 1;
        }
        ...
        if (this.expos - 1 < 0) {
          return this.repeater_array.length - 1;
        } else {
          return this.expos - 1;
        }
    ...
    arrowClick(e) {
      ...
      if (eltouched == "arr_right") {
        this.i++;
        this.expos++;
        if (this.i > this.repeater_array.length - 1) {
          this.i = 0;
        }
        if (this.expos > this.repeater_array.length - 1) {
          this.expos = 0;
        }
        ...
        this.expos--;
        if (this.i < 0) {
          this.i = this.repeater_array.length - 1;
        }
        if (this.expos < 0) {
          this.expos = this.repeater_array.length - 1;
        }
...
#center > * > * > div > div > #repeater_freq {
  animation: textup 0.6s 0s ease forwards;
}
#center > * > * > div > div > #repeater_loc {
  animation: textup 0.6s 0.1s ease forwards;
}
#center > * > * > div > div > div > div {
  animation: textup 0.6s 0.2s ease forwards;
}
#center > * > * > div > div > #repeater_desc {
  animation: textup 0.6s 0.25s ease forwards;
}
#center > * > * > div > img {
...
#left {
  z-index: 2;
  pointer-events: none;
  transform: translateX(-100%) perspective(2000px) scale(80%) scaleX(130%)
    rotateY(30deg);
...
#goInR {
  animation: moveR 0.6s cubic-bezier(0.39, 0.01, 0.55, 0.98) ease forwards;
  z-index: 2;
}
...
#goInL {
  animation: moveL 0.6s cubic-bezier(0.39, 0.01, 0.55, 0.98) ease forwards;
  z-index: 2;
}
@keyframes moveL {
  0% {
