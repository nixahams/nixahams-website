      ...
      if (!this.headerMode) {
        try {
          if (this.viewTypeMobile) {
            ...
            document.getElementById("burgerParentCompress").id =
              "burgerParentExpand";
          } else {
            document.getElementById("burgerOpen").id = "burgerClose";
        ...
        try {
          if (this.viewTypeMobile) {
            ...
            document.getElementById("burgerParentExpand").id =
...
.hoverOpt,
#header_#burgerOptionContainer > a > .hoverOpt:hover,
#header_expand > #burgerOptionContainer > a > .hoverOpt {
  visibility: hidden;
  color: transparent;
  position: absolute;
  padding: 10px;
