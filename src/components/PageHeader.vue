<template>
  <div :id="changeHeader">
    ...
    <div v-if="ham_active" id="header_hamburger_menu">
      <a
        href="/"
        class="header_option_active"
        @click="updateActivePage($event.path[0].innerHTML, 'ham')"
        id="home"
        >home</a
      >
      <a
        href="/About"
        class="header_option_inactive"
        @click="updateActivePage($event.path[0].innerHTML, 'ham')"
        id="about"
        >about</a
      >
    ...
    <div id="header_p2">
      <a
        href="/"
        class="header_option_active"
        @click="updateActivePage($event.path[0].innerHTML, 'normal')"
        id="home"
        >home</a
      >
      <a
...
export default {
  ...
  methods: {
    ...
    updateActivePage(option, key) {
      ...
      try {
        document.getElementById(this.previousPage).className =
          "header_option_inactive";
        document.getElementById(this.activePage).className =
    ...
    onScroll(e) {
      ...
      if (e.target.scrollTop > 10) {
        this.changeHeader = "header_parent_scroll";
      } else {
        this.changeHeader = "header_parent";
      }
    },
  },
  mounted() {
    ...
    this.updateActivePage(
      this.$route.path.toLowerCase().substring(1),
      "normal"
    );
